...
public class Knight extends Piece {
    ...
    /**
     * Méthode pour obtenir les mouvements valides du cavalier à partir de sa position actuelle
    ...
    public List<Point> mouvementsValides(Point position, Board board) {
        ...
        for (int[] saut : sauts) {
            ...
            if (x >= 0 && x < 8 && y >= 0 && y < 8) {
                ...
                if (cible == null || cible.getColor() != this.color) moves.add(new Point(x, y));
            }
        }
        return moves;
    }
